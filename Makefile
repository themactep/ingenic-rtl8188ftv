...
###################### Platform Related #######################
CONFIG_PLATFORM_INGENIC = y
CONFIG_PLATFORM_NVT9851X = n
...
EXTRA_CFLAGS += -DCONFIG_MP_VHT_HW_TX_MODE
ifeq ($(CONFIG_PLATFORM_NVT9851X), y)
...
KSRC ?= /home/heng/work/opensource/kernel-4.4.94
endif

ifeq ($(CONFIG_PLATFORM_NVT9851X), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
ARCH:=mips
CROSS_COMPILE:= /opt/ivot/mipsel-24kec-linux-uclibc-4.9-2017.07/usr/bin/mipsel-24kec-linux-uclibc-
KVER  := $(shell uname -r)
KSRC := $(shell pwd)/../../../linux-kernel/OUTPUT/
#EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
endif
